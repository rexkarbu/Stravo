...
class StravoColors {
  ...
  static const Color neonCyan = electricCyan; // Alias
  ...
  static const Color textTertiary = textMuted; // Alias
  static const Color textDisabled = Color(0xFF424B57);
  static const Color divider = Color(0x1FFFFFFF); // Glass divider line
